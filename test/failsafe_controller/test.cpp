...
public:
  ...
  pairs_lib::ServiceClientHandler<std_srvs::Trigger> sch_failsafe_;
...
Tester::Tester() : pairs_uav_testing::TestGeneric() {
  ...
  sch_failsafe_ = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "/" + _uav_name_ + "/control_manager/failsafe");
}
