...
bool MidairActivationController::initialize(const rclcpp::Node::SharedPtr                                        &node,
  ...
  private_handlers->param_loader->addYamlFile(ament_index_cpp::get_package_share_directory("pairs_uav_controllers") +
  ...
  profiler_ = pairs_lib::Profiler(common_handlers->parent_node, "MidairActivationController", _profiler_enabled_);
...
void MidairActivationController::updateInactive(const pairs_msgs::msg::UavState                                       &uav_state,
...
MidairActivationController::ControlOutput MidairActivationController::updateActive(const pairs_msgs::msg::UavState       &uav_state,
                                                                                   const pairs_msgs::msg::TrackerCommand &tracker_command) {

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("update");
  pairs_lib::ScopeTimer timer =
      pairs_lib::ScopeTimer(node_, "MidairActivationController::update", common_handlers_->scope_timer.logger, common_handlers_->scope_timer.enabled);
  ...
  case common::ATTITUDE: {
    ...
    pairs_msgs::msg::HwApiAttitudeCmd cmd;
  ...
  case common::ATTITUDE_RATE: {
    ...
    pairs_msgs::msg::HwApiAttitudeRateCmd cmd;
  ...
  case common::CONTROL_GROUP: {
    ...
    pairs_msgs::msg::HwApiControlGroupCmd cmd;
  ...
  case common::ACTUATORS_CMD: {
    ...
    pairs_msgs::msg::HwApiActuatorCmd cmd;
...
const pairs_msgs::msg::ControllerStatus MidairActivationController::getStatus() {
...
void MidairActivationController::switchOdometrySource([[maybe_unused]] const pairs_msgs::msg::UavState &new_uav_state) {
}
...
const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Response>
MidairActivationController::setConstraints([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request> &constraints) {
...
double MidairActivationController::getHeadingSafely(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command) {
