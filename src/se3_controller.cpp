...
class Se3Controller : public pairs_uav_managers::Controller {
...
public:
  ...
  void updateInactive(const pairs_msgs::msg::UavState &uav_state, const std::optional<pairs_msgs::msg::TrackerCommand> &tracker_command);

  ControlOutput updateActive(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command);

  const pairs_msgs::msg::ControllerStatus getStatus();

  void switchOdometrySource(const pairs_msgs::msg::UavState &new_uav_state);

  void resetDisturbanceEstimators(void);

  const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Response>
  setConstraints(const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request> &constraints);
...
private:
  ...
  void positionPassthrough(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command);

  void PIDVelocityOutput(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command,
                         const common::CONTROL_OUTPUT &control_output, const double &dt);

  void SE3Controller(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command, const double &dt,
  ...
  double getHeadingSafely(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command);
...
bool Se3Controller::initialize(const rclcpp::Node::SharedPtr &node, std::shared_ptr<pairs_uav_managers::control_manager::CommonHandlers_t> common_handlers,
                               std::shared_ptr<pairs_uav_managers::control_manager::PrivateHandlers_t> private_handlers) {
  ...
  private_handlers->param_loader->addYamlFile(ament_index_cpp::get_package_share_directory("pairs_uav_controllers") + "/config/private/se3_controller.yaml");
  private_handlers->param_loader->addYamlFile(ament_index_cpp::get_package_share_directory("pairs_uav_controllers") + "/config/public/se3_controller.yaml");
  ...
  // output mode
  dynparam_mgr_->register_param("se3/preferred_output", &drs_params_.preferred_output_mode, pairs_lib::DynparamMgr::range_t<int>(0, 3));
  dynparam_mgr_->register_param("se3/rotation_matrix", &drs_params_.rotation_type, pairs_lib::DynparamMgr::range_t<int>(0, 1));
  ...
  sh_imu_ = pairs_lib::SubscriberHandler<sensor_msgs::msg::Imu>(shopts, "/" + common_handlers->uav_name + "/hw_api/imu");
  ...
  dynparam_mgr_->register_param("horizontal.kpxy", &drs_params_.kpxy, gains_.kpxy, pairs_lib::DynparamMgr::range_t<double>(0.0, 40.0));
  dynparam_mgr_->register_param("horizontal.kvxy", &drs_params_.kvxy, gains_.kvxy, pairs_lib::DynparamMgr::range_t<double>(0.0, 40.0));

  dynparam_mgr_->register_param("horizontal.kaxy", &drs_params_.kaxy, gains_.kaxy, pairs_lib::DynparamMgr::range_t<double>(0.0, 2.0));

  dynparam_mgr_->register_param("horizontal.kiwxy", &drs_params_.kiwxy, gains_.kiwxy, pairs_lib::DynparamMgr::range_t<double>(0.0, 10.0));
  dynparam_mgr_->register_param("horizontal.kibxy", &drs_params_.kibxy, gains_.kibxy, pairs_lib::DynparamMgr::range_t<double>(0.0, 10.0));
  dynparam_mgr_->register_param("horizontal.kiwxy_lim", &drs_params_.kiwxy_lim, gains_.kiwxy_lim, pairs_lib::DynparamMgr::range_t<double>(0.0, 10.0));
  dynparam_mgr_->register_param("horizontal.kibxy_lim", &drs_params_.kibxy_lim, gains_.kibxy_lim, pairs_lib::DynparamMgr::range_t<double>(0.0, 10.0));

  dynparam_mgr_->register_param("vertical.kpz", &drs_params_.kpz, gains_.kpz, pairs_lib::DynparamMgr::range_t<double>(0.0, 200.0));
  dynparam_mgr_->register_param("vertical.kvz", &drs_params_.kvz, gains_.kvz, pairs_lib::DynparamMgr::range_t<double>(0.0, 200.0));

  dynparam_mgr_->register_param("vertical.kaz", &drs_params_.kaz, gains_.kaz, pairs_lib::DynparamMgr::range_t<double>(0.0, 2.0));

  dynparam_mgr_->register_param("attitude.kq_roll_pitch", &drs_params_.kq_roll_pitch, gains_.kq_roll_pitch, pairs_lib::DynparamMgr::range_t<double>(0.0, 20.0));

  dynparam_mgr_->register_param("attitude.kq_yaw", &drs_params_.kq_yaw, gains_.kq_yaw, pairs_lib::DynparamMgr::range_t<double>(0.0, 40.0));

  dynparam_mgr_->register_param("mass.km", &drs_params_.km, gains_.km, pairs_lib::DynparamMgr::range_t<double>(0.0, 2.0));

  dynparam_mgr_->register_param("mass.km_lim", &drs_params_.km_lim, gains_.km_lim, pairs_lib::DynparamMgr::range_t<double>(0.0, 50.0));
  ...
  profiler_ = pairs_lib::Profiler(common_handlers->parent_node, "Se3Controller", _profiler_enabled_);
...
bool Se3Controller::activate(const ControlOutput &last_control_output) {
  ...
  if (_rampup_enabled_ && throttle_last_controller) {
    ...
    double hover_throttle = pairs_lib::quadratic_throttle_model::forceToThrottle(common_handlers_->throttle_model, activation_mass * common_handlers_->g, *node_);
...
void Se3Controller::updateInactive(const pairs_msgs::msg::UavState                                       &uav_state,
                                   [[maybe_unused]] const std::optional<pairs_msgs::msg::TrackerCommand> &tracker_command) {
...
Se3Controller::ControlOutput Se3Controller::updateActive(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command) {

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("updateActive");
  pairs_lib::ScopeTimer timer =
      pairs_lib::ScopeTimer(node_, "Se3Controller::updateActive", common_handlers_->scope_timer.logger, common_handlers_->scope_timer.enabled);
...
const pairs_msgs::msg::ControllerStatus Se3Controller::getStatus() {
...
void Se3Controller::switchOdometrySource(const pairs_msgs::msg::UavState &new_uav_state) {
...
const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Response>
Se3Controller::setConstraints([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request> &constraints) {
...
void Se3Controller::SE3Controller(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command, const double &dt,
                                  const common::CONTROL_OUTPUT &output_modality) {

  auto drs_params  = pairs_lib::get_mutexed(mutex_drs_params_, drs_params_);
  auto constraints = pairs_lib::get_mutexed(mutex_constraints_, constraints_);
  auto gains       = pairs_lib::get_mutexed(mutex_gains_, gains_);
  ...
  const Eigen::Matrix3d R = pairs_lib::AttitudeConverter(uav_state.pose.orientation);
  ...
  if (output_modality == common::ACCELERATION_HDG || output_modality == common::ACCELERATION_HDG_RATE) {
    ...
    if (output_modality == common::ACCELERATION_HDG) {
      ...
      pairs_msgs::msg::HwApiAccelerationHdgCmd cmd;
      ...
      pairs_msgs::msg::HwApiAccelerationHdgRateCmd cmd;
      ...
      double hdg_err = pairs_lib::geometry::sradians::diff(tracker_command.heading, uav_heading);
  ...
  if (!rampup_active_) {
    ...
    if (tracker_command.use_acceleration && sh_imu_.hasMsg() && drs_params.fuse_acceleration) {
      ...
      const double desired_bodyz_acc  = pairs_lib::quadratic_throttle_model::throttleToForce(common_handlers_->throttle_model, last_throttle_) / total_mass;
  ...
  if (tracker_command.use_orientation) {
    ...
    Rd = pairs_lib::AttitudeConverter(tracker_command.orientation);

    if (tracker_command.use_heading) {
      try {
        Rd = pairs_lib::AttitudeConverter(Rd).setHeading(tracker_command.heading);
      }
      catch (...) {
  ...
  if (tracker_command.use_throttle) {
    ...
    if (desired_thrust_force >= 0) {
      throttle = pairs_lib::quadratic_throttle_model::forceToThrottle(common_handlers_->throttle_model, desired_thrust_force, *node_);
    } else {
  ...
  last_control_output_.desired_orientation = pairs_lib::AttitudeConverter(Rd);
  ...
  pairs_msgs::msg::HwApiAttitudeCmd attitude_cmd;

  attitude_cmd.stamp       = clock_->now();
  attitude_cmd.orientation = pairs_lib::AttitudeConverter(Rd);
  ...
  if (tracker_command.use_attitude_rate) {
    ...
    try {
      desired_yaw_rate = pairs_lib::AttitudeConverter(Rd).getYawRateIntrinsic(tracker_command.heading_rate);
    }
    catch (...) {
  ...
  {
    try {
      last_control_output_.desired_heading_rate = pairs_lib::AttitudeConverter(R).getHeadingRate(attitude_rate_command->body_rate);
    }
    catch (...) {
    }
  }
  ...
  pairs_msgs::msg::HwApiActuatorCmd actuator_cmd =
...
void Se3Controller::positionPassthrough(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command) {
  ...
  pairs_msgs::msg::HwApiPositionCmd cmd;
...
void Se3Controller::PIDVelocityOutput(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command,
                                      const common::CONTROL_OUTPUT &control_output, const double &dt) {
  ...
  if (control_output == common::VELOCITY_HDG) {
    ...
    pairs_msgs::msg::HwApiVelocityHdgCmd cmd;
    ...
    double hdg_err = pairs_lib::geometry::sradians::diff(hdg_ref, hdg);
    ...
    pairs_msgs::msg::HwApiVelocityHdgRateCmd cmd;
...
void Se3Controller::timerGains() {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerGains");
  pairs_lib::ScopeTimer timer =
      pairs_lib::ScopeTimer(node_, "Se3Controller::timerGains", common_handlers_->scope_timer.logger, common_handlers_->scope_timer.enabled);
  ...
  pairs_lib::set_mutexed(mutex_gains_, gains, gains_);
...
double Se3Controller::getHeadingSafely(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command) {
...
PLUGINLIB_EXPORT_CLASS(pairs_uav_controllers::se3_controller::Se3Controller, pairs_uav_managers::Controller)
