...
std::optional<pairs_msgs::HwApiAttitudeRateCmd> attitudeController(const pairs_msgs::UavState& uav_state, const pairs_msgs::HwApiAttitudeCmd& reference,
...
std::optional<pairs_msgs::HwApiControlGroupCmd> attitudeRateController(const pairs_msgs::UavState& uav_state, const pairs_msgs::HwApiAttitudeRateCmd& reference,
...
pairs_msgs::HwApiActuatorCmd actuatorMixer(const pairs_msgs::HwApiControlGroupCmd& ctrl_group_cmd, const Eigen::MatrixXd& mixer) {
  ...
  pairs_msgs::HwApiActuatorCmd actuator_msg;
