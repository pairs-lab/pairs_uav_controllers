...
std::optional<pairs_msgs::msg::HwApiAttitudeRateCmd> attitudeController(const rclcpp::Node::SharedPtr &node, const pairs_msgs::msg::UavState &uav_state,
                                                                      const pairs_msgs::msg::HwApiAttitudeCmd &reference, const Eigen::Vector3d &ff_rate,
  ...
  Eigen::Matrix3d Rd = pairs_lib::AttitudeConverter(reference.orientation);
  ...
  if (parasitic_heading_rate_compensation) {
    ...
    try {
      parasitic_heading_rate = pairs_lib::AttitudeConverter(uav_state.pose.orientation).getHeadingRate(q_feedback_yawless);
    }
    catch (...) {
    ...
    try {
      rp_heading_rate_compensation(2) = pairs_lib::AttitudeConverter(uav_state.pose.orientation).getYawRateIntrinsic(-parasitic_heading_rate);
    }
    catch (...) {
...
std::optional<pairs_msgs::msg::HwApiControlGroupCmd> attitudeRateController(const rclcpp::Node::SharedPtr &node, const pairs_msgs::msg::UavState &uav_state,
                                                                          const pairs_msgs::msg::HwApiAttitudeRateCmd &reference, const Eigen::Vector3d &gains) {
...
pairs_msgs::msg::HwApiActuatorCmd actuatorMixer(const rclcpp::Node::SharedPtr &node, const pairs_msgs::msg::HwApiControlGroupCmd &ctrl_group_cmd,
  ...
  pairs_msgs::msg::HwApiActuatorCmd actuator_msg;
