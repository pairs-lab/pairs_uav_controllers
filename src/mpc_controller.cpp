...
class MpcController : public pairs_uav_managers::Controller {
...
private:
  ...
  void MPC(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command, const double &dt,
  ...
  pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool> ss_set_integral_terms_;
...
bool MpcController::initialize(const rclcpp::Node::SharedPtr &node, std::shared_ptr<pairs_uav_managers::control_manager::CommonHandlers_t> common_handlers,
                               std::shared_ptr<pairs_uav_managers::control_manager::PrivateHandlers_t> private_handlers) {
  ...
  private_handlers->param_loader->addYamlFile(ament_index_cpp::get_package_share_directory("pairs_uav_controllers") + "/config/private/mpc_controller.yaml");
  private_handlers->param_loader->addYamlFile(ament_index_cpp::get_package_share_directory("pairs_uav_controllers") + "/config/public/mpc_controller.yaml");
  private_handlers->param_loader->addYamlFile(ament_index_cpp::get_package_share_directory("pairs_uav_controllers") + "/config/private/" +
                                              private_handlers->name_space + ".yaml");
  private_handlers->param_loader->addYamlFile(ament_index_cpp::get_package_share_directory("pairs_uav_controllers") + "/config/public/" +
                                              private_handlers->name_space + ".yaml");
  ...
  // output mode
  dynparam_mgr_->register_param("so3/preferred_output", &drs_params_.preferred_output_mode, pairs_lib::DynparamMgr::range_t<int>(0, 3));
  ...
  ss_set_integral_terms_ = pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>(
  ...
  profiler_ = pairs_lib::Profiler(common_handlers->parent_node, "MpcController", _profiler_enabled_);
...
void MpcController::updateInactive(const pairs_msgs::msg::UavState                                       &uav_state,
...
MpcController::ControlOutput MpcController::updateActive(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command) {

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("updateActive");
  pairs_lib::ScopeTimer timer =
      pairs_lib::ScopeTimer(node_, "MpcController::updateActive", common_handlers_->scope_timer.logger, common_handlers_->scope_timer.enabled);
...
const pairs_msgs::msg::ControllerStatus MpcController::getStatus() {
...
void MpcController::switchOdometrySource(const pairs_msgs::msg::UavState &new_uav_state) {
...
const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Response>
MpcController::setConstraints([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request> &constraints) {
...
void MpcController::MPC(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command, const double &dt,
                        const common::CONTROL_OUTPUT &output_modality) {
  ...
  Eigen::Matrix3d R = pairs_lib::AttitudeConverter(uav_state.pose.orientation);
...
void MpcController::positionPassthrough(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command) {
...
void MpcController::PIDVelocityOutput(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command,
                                      const common::CONTROL_OUTPUT &control_output, const double &dt) {
...
void MpcController::timerGains() {
  ...
  pairs_lib::ScopeTimer timer =
      pairs_lib::ScopeTimer(node_, "MpcController::timerGains", common_handlers_->scope_timer.logger, common_handlers_->scope_timer.enabled);
...
double MpcController::getHeadingSafely(const pairs_msgs::msg::UavState &uav_state, const pairs_msgs::msg::TrackerCommand &tracker_command) {
...
PLUGINLIB_EXPORT_CLASS(pairs_uav_controllers::mpc_controller::MpcController, pairs_uav_managers::Controller)
